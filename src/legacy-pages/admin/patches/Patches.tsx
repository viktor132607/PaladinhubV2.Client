...
export default function Patches() {
  ...
  return <section>
    ...
    <div className="d-flex flex-wrap gap-2 mb-3">
      <button type="button" className="btn btn-primary" disabled={busy} onClick={() => choose(null)}>New patch</button>
    ...
    <div className="row g-3">
      ...
      <div className="col-12 col-xl-5" style={{ minWidth: 0 }}>
        <h3>{selected ? `${selected.isDeleted ? "Deleted" : "Edit"} patch #${selected.id}` : "New patch"}</h3>
        <form onSubmit={submit}>
          <fieldset disabled={busy || selected?.isDeleted}>
            ...
            <div className="d-flex flex-wrap gap-2">
              <button type="submit" className="btn btn-success">{busy ? "Saving…" : selected ? "Save patch" : "Create patch"}</button>
