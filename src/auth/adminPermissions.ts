export const adminPermissions = {
  users: { read: "users.read", create: "users.create", update: "users.update", delete: "users.delete", manage: "users.manage" },
  ...
  talentPages: { read: "talent_pages.read", create: "talent_pages.create", update: "talent_pages.update", delete: "talent_pages.delete", manage: "talent_pages.manage" },
  ...
  media: { read: "media.read", create: "media.create", update: "media.update", archive: "media.archive", delete: "media.delete", restore: "media.restore", manage: "media.manage" },
  ...
  spellIcons: { read: "spell_icons.read", create: "spell_icons.create", delete: "spell_icons.delete", manage: "spell_icons.manage" },
  ...
  productReviews: { read: "product_reviews.read", delete: "product_reviews.delete", manage: "product_reviews.manage" },
  promoCodes: { read: "promo_codes.read", create: "promo_codes.create", update: "promo_codes.update", delete: "promo_codes.delete", manage: "promo_codes.manage" },
} as const;
