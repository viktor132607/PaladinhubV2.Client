...
const retributionHeraldNodes = [
  { id: "dawnlight", name: "Dawnlight", column: 2, row: 1, cost: 1 },

  { id: "gleaming-rays", name: "Gleaming Rays", column: 1, row: 2, cost: 1 },
  { id: "eternal-flame", name: "Eternal Flame", column: 2, row: 2, cost: 1 },
  { id: "luminosity", name: "Luminosity", column: 3, row: 2, cost: 1 },

  { id: "will-of-the-dawn", name: "Will of the Dawn", column: 1, row: 3, cost: 1 },
  { id: "blessing-of-an-she", name: "Blessing of An'she", column: 2, row: 3, cost: 1 },
  { id: "sun-sear", name: "Sun Sear", column: 3, row: 3, cost: 1 },

  { id: "aurora", name: "Aurora", column: 1, row: 4, cost: 1 },
  { id: "solar-grace", name: "Solar Grace", column: 2, row: 4, cost: 1 },
  { id: "second-sunrise", name: "Second Sunrise", column: 3, row: 4, cost: 1 },

  { id: "sun-s-avatar", name: "Sun's Avatar", column: 2, row: 5, cost: 1 },
] satisfies TalentNode[];

const retributionNodes = [
  { id: "blade-of-justice", name: "Blade of Justice", column: 5, row: 1, cost: 1 },

  { id: "divine-storm", name: "Divine Storm", column: 5, row: 2, cost: 1 },

  { id: "swift-justice", name: "Swift Justice", column: 2, row: 3, cost: 1 },
  { id: "expurgation", name: "Expurgation", column: 4, row: 3, cost: 1 },
  {
  ...
  { id: "holy-blade", name: "Holy Blade", column: 8, row: 3, cost: 1 },

  { id: "final-verdict", name: "Final Verdict", column: 2, row: 4, cost: 1 },
  { id: "guided-prayer", name: "Guided Prayer", column: 5, row: 4, cost: 1 },
  { id: "art-of-war", name: "Art of War", column: 8, row: 4, cost: 1 },

  { id: "jurisdiction", name: "Jurisdiction", column: 1, row: 5, cost: 1 },
  {
  ...
  { id: "crusade", name: "Crusade", column: 5, row: 5, cost: 1 },
  {
  ...
  { id: "zealot-s-fervor", name: "Zealot's Fervor", column: 8, row: 5, cost: 1 },
  { id: "rush-of-light", name: "Rush of Light", column: 9, row: 5, cost: 1 },
  ...
  { id: "divine-wrath", name: "Divine Wrath", column: 5, row: 6, cost: 1 },
  { id: "divine-hammer", name: "Divine Hammer", column: 6, row: 6, cost: 1 },
  { id: "holy-flames", name: "Holy Flames", column: 8, row: 6, cost: 1 },

  { id: "empyrean-legacy", name: "Empyrean Legacy", column: 1, row: 7, cost: 1 },
  {
  ...
  { id: "highlord-s-wrath", name: "Highlord's Wrath", column: 3, row: 7, cost: 1 },
  { id: "wake-of-ashes", name: "Wake of Ashes", column: 5, row: 7, cost: 1 },
  {
    id: "blessed-champion",
  ...
  { id: "adjudication", name: "Adjudication", column: 2, row: 8, cost: 1 },
  {
  ...
  { id: "penitence", name: "Penitence", column: 8, row: 8, cost: 1 },

  { id: "blades-of-light", name: "Blades of Light", column: 2, row: 9, cost: 1 },
  {
  ...
  { id: "seething-flames", name: "Seething Flames", column: 6, row: 9, cost: 1 },
  { id: "burning-crusade", name: "Burning Crusade", column: 8, row: 9, cost: 1 },

  { id: "divine-arbiter", name: "Divine Arbiter", column: 2, row: 10, cost: 1 },
  {
  ...
  { id: "divine-auxiliary", name: "Divine Auxiliary", column: 4, row: 10, cost: 1 },
  { id: "radiant-glory", name: "Radiant Glory", column: 6, row: 10, cost: 1 },
  { id: "burn-to-ash", name: "Burn to Ash", column: 7, row: 10, cost: 1 },
  { id: "searing-light", name: "Searing Light", column: 8, row: 10, cost: 1 },
] satisfies TalentNode[];
...
const heraldTreeNodes =
  withOriginalNodeShapes(
    retributionHeraldNodes,
  );
...
export default function RetributionTreeHerald() {
  return (
    <section
      className="w-full bg-[#151515] text-white"
      data-build="retribution-herald"
    >
      <div className="w-full overflow-x-auto">
        ...
        >
          ...
          <TreeColumn
            ...
            treeKey="retribution-herald"
            nodes={heraldTreeNodes}
            maxPoints={10}
            columns={3}
            widthClass="w-[250px]"
            edges={heraldEdges}
