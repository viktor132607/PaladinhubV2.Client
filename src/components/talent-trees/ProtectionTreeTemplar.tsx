...
export default function ProtectionTreeTemplar() {
  return (
    <section
      className="w-full bg-[#151515] text-white"
      data-build="protection-templar"
    >
