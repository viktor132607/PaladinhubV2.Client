...
const paladinNodes = [
  ...
  { id: "auras-of-the-resolute", name: "Auras of the Resololute", column: 4, row: 1, cost: 1 },
...
const holyHeraldNodes = [
  ...
  { id: "blessing-of-anshe", name: "Blessing of An'she", column: 2, row: 3, cost: 1 },
  ...
  { id: "suns-avatar", name: "Sun's Avatar", column: 2, row: 5, cost: 1 },
] satisfies TalentNode[];
...
const heraldTreeNodes = withOriginalNodeShapes(holyHeraldNodes);
...
export default function HolyTalentTreeHerald() {
  return (
    <section
      className="w-full bg-[#151515] text-white"
      data-build="holy-herald"
    >
